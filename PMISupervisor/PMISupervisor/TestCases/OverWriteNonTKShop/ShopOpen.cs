...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("4c2f0063-b987-4624-9306-ead679752fe4", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PMI_Supervisor.Validate_InfoPopUp'.", repo.PMI_Supervisor.Validate_InfoPopUpInfo, new RecordItemIndex(4));
            Validate.Exists(repo.PMI_Supervisor.Validate_InfoPopUpInfo);
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.YesButton' at Center", repo.PMI_Supervisor.YesButtonInfo, new RecordItemIndex(5));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PMI_Supervisor.CheckInButton'.", repo.PMI_Supervisor.CheckInButtonInfo, new RecordItemIndex(7));
            Validate.Exists(repo.PMI_Supervisor.CheckInButtonInfo);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.CheckInButton' at Center", repo.PMI_Supervisor.CheckInButtonInfo, new RecordItemIndex(8));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.UserLocationIsIncorrect' at Center", repo.PMI_Supervisor.UserLocationIsIncorrectInfo, new RecordItemIndex(10));
            repo.PMI_Supervisor.UserLocationIsIncorrect.Touch();
            Delay.Milliseconds(500);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PMI_Supervisor.ShopRemarks_List'.", repo.PMI_Supervisor.ShopRemarks_ListInfo, new RecordItemIndex(11));
            Validate.Exists(repo.PMI_Supervisor.ShopRemarks_ListInfo);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.ShopOpen' at Center", repo.PMI_Supervisor.ShopOpenInfo, new RecordItemIndex(12));
            repo.PMI_Supervisor.ShopOpen.Touch();
            Delay.Milliseconds(500);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PMI_Supervisor.Validate_CameraScreen'.", repo.PMI_Supervisor.Validate_CameraScreenInfo, new RecordItemIndex(13));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.ButtonDone' at Center", repo.PMI_Supervisor.ButtonDoneInfo, new RecordItemIndex(15));
            repo.PMI_Supervisor.ButtonDone.Touch();
            Delay.Milliseconds(500);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PMI_Supervisor.Validate_InfoPopUp'.", repo.PMI_Supervisor.Validate_InfoPopUpInfo, new RecordItemIndex(16));
            Validate.Exists(repo.PMI_Supervisor.Validate_InfoPopUpInfo);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PMI_Supervisor.YesButton' at Center", repo.PMI_Supervisor.YesButtonInfo, new RecordItemIndex(17));
            repo.PMI_Supervisor.YesButton.Touch();
            Delay.Milliseconds(500);
            
            UserCode.UserCode.loadNonTKTPOSMForOverWriting();
            Delay.Milliseconds(0);
